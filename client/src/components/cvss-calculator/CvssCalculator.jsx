...
export default function CvssCalculator() {
    ...
    const data = [{
        ...
        {
            subject: 'Modified Exploitability: ' +
    ...
    function exportCalculationJson() {
        const cvssJson = {
            ...
            base: {
                ...
                attackVector: cvssScores.base.attackVector === 'N' ?
                    'Network' :
                    ...
                    'Physical' :
                    'Unknown',
                attackComplexity: cvssScores.base.attackComplexity === 'L' ?
                    'Low' :
                    cvssScores.base.attackComplexity === 'H' ?
                    'High' :
                    'Unknown',
                privilegesRequired: cvssScores.base.privilegesRequired === 'N' ?
                    'None' :
                    ...
                    'High' :
                    'Unknown',
                userInteraction: cvssScores.base.userInteraction === 'N' ?
                    'None' :
                    cvssScores.base.userInteraction === 'R' ?
                    'Required' :
                    'Unknown',
                scope: cvssScores.base.scope === 'U' ?
                    'Unchanged' :
            ...
            temporal: {
                ...
                exploitCodeMaturity: cvssScores.temporal.exploitCodeMaturity === 'X' ?
                    'Not Defined' :
                    ...
                    'Unproven' :
                    'Unknown',
                remediationLevel: cvssScores.temporal.remediationLevel === 'X' ?
                    'Not Defined' :
                    ...
                    'Unavailable' :
                    'Unknown',
                reportConfidence: cvssScores.temporal.reportConfidence === 'X' ?
                    'Not Defined' :
            ...
            environmental: {
                ...
                modifiedExploitabilityScore: Math.round(
                ...
                modifiedAttackVector: cvssScores.environmental.modifiedAttackVector === 'X' ?
                    'Not Defined' :
                    ...
                    'Physical' :
                    'Unknown',
                modifiedAttackComplexity: cvssScores.environmental.modifiedAttackComplexity === 'X' ?
                    'Not Defined' :
                    ...
                    'High' :
                    'Unknown',
                modifiedPrivilegesRequired: cvssScores.environmental.modifiedPrivilegesRequired === 'X' ?
                    'Not Defined' :
                    ...
                    'High' :
                    'Unknown',
                modifiedUserInteraction: cvssScores.environmental.modifiedUserInteraction === 'X' ?
                    'Not Defined' :
                    ...
                    'Required' :
                    'Unknown',
                modifiedScope: cvssScores.environmental.modifiedScope === 'X' ?
                    'Not Defined' :
                    ...
                    'Changed' :
                    'Unknown',
                modifiedConfidentialityImpact: cvssScores.environmental.modifiedConfidentialityImpact === 'X' ?
                    'Not Defined' :
                    ...
                    'None' :
                    'Unknown',
                modifiedIntegrityImpact: cvssScores.environmental.modifiedIntegrityImpact === 'X' ?
                    'Not Defined' :
                    ...
                    'None' :
                    'Unknown',
                modifiedAvailabilityImpact: cvssScores.environmental.modifiedAvailabilityImpact === 'X' ?
                    'Not Defined' :
                    ...
                    'None' :
                    'Unknown',
                confidentialityRequirement: cvssScores.environmental.confidentialityRequirement === 'X' ?
                    'Not Defined' :
                    ...
                    'High' :
                    'Unknown',
                integrityRequirement: cvssScores.environmental.integrityRequirement === 'X' ?
                    'Not Defined' :
                    ...
                    'High' :
                    'Unknown',
                availabilityRequirement: cvssScores.environmental.availabilityRequirement === 'X' ?
                    'Not Defined' :
